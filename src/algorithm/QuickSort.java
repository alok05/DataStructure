package algorithm;// Java implementation of algorithm.QuickSort
/*
* Time taken by algorithm.QuickSort, in general, can be written as following.
...
The time taken by algorithm.QuickSort depends upon the input array and partition strategy. Following are three
cases.
...
Although the worst case time complexity of algorithm.QuickSort is O(n2) which is more than many other sorting
algorithms like Merge Sort and Heap Sort, algorithm.QuickSort is faster in practice, because its inner loop
can be efficiently implemented on most architectures, and in most real-world data. algorithm.QuickSort can be
...
class QuickSort {
    ...
    /* The main function that implements algorithm.QuickSort
