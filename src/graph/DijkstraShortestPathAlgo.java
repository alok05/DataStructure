package graph;// Java Program to Implement Dijkstra's Algorithm
...
public class DijkstraShortestPathAlgo {
    ...
    public DijkstraShortestPathAlgo(int V) {
    ...
    public static void main(String[] arg) {
        ...
        DijkstraShortestPathAlgo dpq = new DijkstraShortestPathAlgo(V);
